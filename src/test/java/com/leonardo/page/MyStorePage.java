...
public class MyStorePage {
    ...
    public static By enlaceLogin = By.cssSelector(".user-info a");
    ...
    public static By usuarioCabecera = By.cssSelector(".account span");
    ...
    public static By getMenuCategoria(String categoria) {
        return By.cssSelector("a[href*='" + categoria.toLowerCase() + "']");
    }
     public static By getMenuSubCategoria(String subcategoria) {
         return By.cssSelector(".category-sub-menu a[href*='" + subcategoria.toLowerCase() + "']");
     }
